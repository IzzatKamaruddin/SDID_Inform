          ...
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              <h4 className="text-black dark:text-white font-medium uppercase">
                ...
                Statitics Analytics Dashboard
              </h4>
              <h2 className="relative font-bold text-black dark:text-white text-3xl xl:text-hero mb-6">
                Analytics Dashboard Q2 2023
                
              </h2>
              <p>
              A one-stop platform that makes it easier for users to discover insights into the Communications & Multimedia as well as Postal & Courier industry
              </p>
              <div>
                <a
                  href="#"
