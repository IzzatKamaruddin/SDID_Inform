        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          <div className="flex lg:items-center lg:gap-8 xl:gap-32.5">
            <div className=" md:w-1/2">
              ...
              <p>
              INFORM is a one-stop data platform that enables you to efficiently and securely explore as well as exchange data assets across organizations for better decision making. It will pave the way for open data and data sharing initiatives.
              </p>
