            ...
            <div className="lg:w-2/3">
              <div className="animate_top rounded-md shadow-solid-13 bg-white dark:bg-blacksection border border-stroke dark:border-strokedark p-7.5 md:p-10">
                ...
                <h2 className="font-semibold text-3xl 2xl:text-sectiontitle2 text-black dark:text-white mt-11 mb-5">
                  Communication and Multimedia Statistical Dashboard
                </h2>

                <ul className="flex flex-wrap gap-5 2xl:gap-7.5 mb-9">
                  <li>
                    <span className="text-black dark:text-white">Author: </span>{" "}
                    Hafiz Yazid , Izzat Kamaruddin 
                  </li>
                  <li>
                ...
                <div className="blog-details">
                  ...
                  {/* <Link href={`https://cognos.mcmc.gov.my/ibmcognos/bi/?perspective=dashboard&pathRef=.public_folders%2FMy%2BContent_Backup%2FInfographic%2FDashboard%2FInfographic_C%2526M_R&action=view&mode=dashboard&subView=model0000018b22cdb856_00000008`}>
